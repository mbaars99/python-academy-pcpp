...
print(p1.print_document())
print(p1.get_printer_status())
print()
...
print(p2.scan_document())
print(p2.get_scanner_status())
...
print(p3.scan_document())
print(p3.get_scanner_status())
print(p3.print_document())
print(p3.get_printer_status())
